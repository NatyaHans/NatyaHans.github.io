...
Hipergator recently updated to a dual factor authentication for logging in, which means for people who use it daily and and need to login multiple sessions, it can get annoying pretty fast. 
...
In other words, given that you log in and authenticate once, and as long as the initial terminal remains open, you can log into multiple sessions without authentication. Although I would advise against it, but you can increase the time from 8hrs.
...
You will then have to copy your id  using ssh copy as follows:
...
ssh hpg
```
At this point if you woul like, you can create an alias for it. See my [blog post here](https://natyahans.github.io/posts/2019/05/SetAliases/)
